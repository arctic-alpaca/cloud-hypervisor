...
use vmm::vm::Vm;
use vmm::vm_config;
use vmm::vm_config::{RngConfig, VmConfig};
...
enum Error {
    ...
    ParsingRestore(#[source] api::types::ParseRestoreError),
...
fn get_cli_options_sorted(
    ...
    [
        ...
        Arg::new("balloon")
            .long("balloon")
            .help(api::types::BalloonConfig::SYNTAX)
            .num_args(1)
            .group("vm-config"),
        Arg::new("cmdline")
            .long("cmdline")
        ...
        Arg::new("console")
            .long("console")
            .help(api::types::ConsoleConfig::SYNTAX)
            .default_value("tty")
            .group("vm-config"),
        Arg::new("cpus")
            .long("cpus")
        ...
        Arg::new("fw-cfg-config")
            .long("fw-cfg-config")
            .help(api::types::FwCfgConfig::SYNTAX)
            .num_args(1)
            .group("vm-payload"),
        #[cfg(feature = "guest_debug")]
        Arg::new("gdb")
        ...
        Arg::new("ivshmem")
            .long("ivshmem")
            .help(api::types::IvshmemConfig::SYNTAX)
            .num_args(1)
            .group("vm-config"),
        Arg::new("kernel")
            .long("kernel")
        ...
        Arg::new("landlock-rules")
            .long("landlock-rules")
            .help(api::types::LandlockConfig::SYNTAX)
            .num_args(1..)
            .action(ArgAction::Append)
            .group("vm-config"),
        Arg::new("log-file")
        ...
        Arg::new("numa")
            .long("numa")
            .help(api::types::NumaConfig::SYNTAX)
            .num_args(1..)
            .action(ArgAction::Append)
            .group("vm-config"),
        Arg::new("pci-segment")
            .long("pci-segment")
            .help(api::types::PciSegmentConfig::SYNTAX)
            .num_args(1..)
            .action(ArgAction::Append)
            .group("vm-config"),
        Arg::new("platform")
            .long("platform")
            .help(api::types::PlatformConfig::syntax())
            .num_args(1)
            .group("vm-config"),
        Arg::new("pmem")
            .long("pmem")
        ...
        Arg::new("rate-limit-group")
            ...
            .help(api::types::RateLimiterGroupConfig::SYNTAX)
            .num_args(1..)
            .action(ArgAction::Append)
            .group("vm-config"),
        Arg::new("restore")
        ...
        Arg::new("rng")
            .long("rng")
            .help(api::types::RngConfig::SYNTAX)
            .default_value(default_rng)
            .group("vm-config"),
        Arg::new("rtc")
            .long("rtc")
            .help(api::types::RtcConfig::SYNTAX)
            .num_args(0..=1)
        ...
        Arg::new("serial")
            .long("serial")
            .help(api::types::SerialConfig::SYNTAX)
            .default_value("null")
            .group("vm-config"),
        Arg::new("tpm")
            .long("tpm")
            .num_args(1)
            .help(api::types::TpmConfig::SYNTAX)
            .group("vm-config"),
        Arg::new("user-device")
            .long("user-device")
...
fn start_vmm(
    ...
    let r: Result<(), Error> = (|| {
        ...
        if payload_present {
            ...
            let vm_config: VmConfig = api::types::VmConfig::parse(vm_params)
                .map_err(Error::ParsingConfig)?
                .try_into()
                .map_err(|error| Error::ParsingConfig(config::Error::Validation(error)))?;
            ...
            api::VmRestore
                .send(
                    api_evt.try_clone().unwrap(),
                    api_request_sender,
                    api::types::RestoreConfig::parse(restore_params)
...
mod unit_tests {
    ...
    fn get_vm_config_from_vec(args: &[&str]) -> VmConfig {
        ...
        api::types::VmConfig::parse(vm_params)
            .unwrap()
            .try_into()
            .unwrap()
    }
    ...
    fn compare_vm_config_cli_vs_json(
        ...
        let openapi_vm_config: VmConfig = serde_json::from_str::<api::types::VmConfig>(openapi)
            .unwrap()
            .try_into()
            .unwrap();
