...
use crate::external_fds::IngestScmRights;
            ...
            Method::Put => {
                match &req.body {
                    Some(body) => {
                        ...
                        if let Err(error) = vm_config.ingest_fds(Vec::new()) {
                            return error_response(error.into(), StatusCode::BadRequest);
                        }
