...
impl SendAdditionalConnections {
    ...
    fn send_memory(
        ...
        if thread_len == 0 {
            for chunk in table.partition(Self::CHUNK_SIZE, PAGE_SIZE as u64, &self.guest_memory) {
        ...
        'next_chunk: for chunk in
            table.partition(Self::CHUNK_SIZE, PAGE_SIZE as u64, &self.guest_memory)
        {
